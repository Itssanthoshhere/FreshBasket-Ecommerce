...
import shopsidebarBanner from "@/public/Shop-sale-banner.webp";
...
export default function Shop() {
  ...
  const filteredProducts = sortedData?.filter((product) => {
    ...
    const sizeMatch = sizeFilter.length === 0 || sizeFilter.includes("1kg");

    return availabilityMatch && sizeMatch;
  });
  ...
  return (
    <>
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-5 px-5 lg:px-8 xl:px-20 py-12">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-5 lg:w-1/2 sticky top-0 left-0 h-full">
          {/* Availability */}
          <div className="">
            <div className="border-t border-gray-400 w-full lg:w-4/5"></div>
            ...
            <div className="py-5">
              ...
              <div className="flex flex-col gap-4">
                {randomProducts.map((product) => (
                  <div
                    key={product.id}
                    className="flex gap-4 border border-gray-200 rounded-lg p-3 hover:shadow-md transition"
                  >
                    {/* Image */}
                    ...
                    <div className="flex flex-col justify-between flex-1">
                      ...
                      <button
                        ...
                        className="w-full rounded py-2 font-semibold text-xs bg-gray-light hover:bg-black transition-colors duration-300 hover:text-white cursor-pointer flex items-center justify-center"
                      >
                        ADD TO CART
                        <Icon
          ...
          <div className="mt-6 w-full lg:w-4/5">
            <div className="overflow-hidden rounded-2xl group">
              <Image
                src={shopsidebarBanner}
                alt="shopsidebarBanner"
                className="w-full h-full object-cover group-hover:scale-110 cursor-pointer transition-all duration-300"
              />
            </div>
          </div>
        </div>
            ...
            <div>
              <div className="flex items-center gap-3 py-4">
                ...
                <button
                  ...
                  className="text-lg cursor-pointer font-medium text-red-500 hover:text-red-600 underline transition"
                >
                  Clear All
                </button>
              </div>

              <div className="shop-banner my-5">
                <Image
                  src={shopBanner}
                  alt="shopBanner"
              ...
              <div className="flex items-center gap-4">
                <h2 className="font-semibold tracking-wide">Sort By :</h2>
